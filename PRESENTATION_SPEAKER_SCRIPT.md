# StudyWell One-Page Speaker Script

## 0:00-0:30 | Opening
Hello judges, and thank you for your time.
We built StudyWell, a student wellness platform that combines study tracking, fitness, nutrition, hydration, and AI-assisted learning in one place.
...
StudyWell solves this by turning disconnected tasks into one clear, daily system.

## 1:10-1:50 | Architecture and Technology
StudyWell is built with FastAPI on the backend, using async routes for responsiveness.
...
What makes StudyWell strong is not one isolated feature.
...
## 5:10-5:30 | Closing
StudyWell addresses a real student problem with a complete and usable solution.
